...
// For more information, see https://docs.microsoft.com/rest/api/storageservices/delete-blob.
func (pb *Client) PermanentDelete(ctx context.Context, o *blob.PermanentDeleteOptions) (blob.PermanentDeleteResponse, error) {
	return pb.BlobClient().PermanentDelete(ctx, o)
}
