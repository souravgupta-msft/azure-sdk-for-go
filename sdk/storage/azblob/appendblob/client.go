...
// For more information, see https://docs.microsoft.com/rest/api/storageservices/delete-blob.
func (ab *Client) PermanentDelete(ctx context.Context, o *blob.PermanentDeleteOptions) (blob.PermanentDeleteResponse, error) {
	return ab.BlobClient().PermanentDelete(ctx, o)
}
